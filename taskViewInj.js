...
function injectKanbanView() {
    return `
        ...
        <div id="kanbanView" class="hidden">
            <button id="addTask" class="bg-green-500 text-white px-4 py-2 w-40 rounded mb-4">+ Add Task</button>
            <div class="flex gap-10 justify-center">
                <!-- Tasks Column -->
                <div id="tasks" class="column flex flex-col border-2 rounded-xl p-5 pb-28 w-96 bg-white" ondrop="drop(event)" ondragover="allowDrop(event)">
                ...
                <!-- Inprocess Column -->
                <div id="inprocess" class="column flex flex-col border-2 rounded-xl p-5 pb-28 w-96 bg-white" ondrop="drop(event)" ondragover="allowDrop(event)">
                ...
                <!-- Done Column -->
                <div id="done" class="column flex flex-col border-2 rounded-xl p-5 pb-28 w-96 bg-white" ondrop="drop(event)" ondragover="allowDrop(event)">
...
function injectListView() {
    return `
        <!-- Task List -->
        <div id="listView">
            <button id="addTaskList" class="bg-green-500 text-white px-4 py-2 rounded mb-4">+ Add Task</button>
            <table class="min-w-full bg-white">
                <thead>
                    <tr>
                        <th class="py-2 px-4 border-b border-gray-200">Task ID</th>
                        <th class="py-2 px-4 border-b border-gray-200">Task</th>
                        <th class="py-2 px-4 border-b border-gray-200">Due Date</th>
                        <th class="py-2 px-4 border-b border-gray-200">Priority</th>
                        <th class="py-2 px-4 border-b border-gray-200">List</th>
